...
{
public:
    std::vector<std::string> technical_interests =
    {
        "Quant Trading",
        "Formal Verification",
        "ML/AI",
        "Cryptograhy & Cybersecurity"
    };

    std::string currently_building =
        "Dungeon crawler to gamify Anki decks";

    std::string currently_studying =
        "Google ML for Trading Specialization";

    std::string fun_fact =
        "Once held a world record for balancing wooden blocks!";
};
```
